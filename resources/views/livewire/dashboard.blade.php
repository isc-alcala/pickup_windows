                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-semibold">Carrier
                                                        {{ $truck->relaciones->carrier->nombre }}
                                                    </p>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                ...
                                                <div>
                                                <button
                                                    wire:click="$emit('openModal', '{{ $truck->id }}')
                                            class="flex
                                                    items-center justify-between px-2 py-2 text-sm font-medium leading-5
