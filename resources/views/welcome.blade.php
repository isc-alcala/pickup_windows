                                    ...
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <a href="{{ route('truck.test', ['id' => $truck->id, 'status' => 6]) }}">
                                            <button type="button"
                                                ...
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                                    viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M10 8.586l4.293-4.293a1 1 0 011.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 011.414-1.414L10 8.586z" clip-rule="evenodd"></path>
                                                </svg>
                                            </button>
                                        </a>
